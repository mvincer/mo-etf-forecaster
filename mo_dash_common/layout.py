...
This is the canonical implementation. The legacy module
``ETF/ETF Forecaster/project/utils/mo_dash_layout.py`` re-exports
everything below for backward compatibility.
"""
